...
def Inception(x, filters):
    ...
    path4 = Conv2D(filters=filters[1][1], kernel_size=(3,3), strides=1, padding='same', activation='relu')(path4)
...
# googleNet want 224, 224 image. but mnist isn't 224,224. they are 28,28. so we resizing.
...
# model = tf.keras.layers.Resizeing(\
...
# stage5
model = Inception(model, [256, (160, 320), (32, 128), 128]) #5a
model = Inception(model, [386, (192, 384), (48, 128), 128]) #5b
