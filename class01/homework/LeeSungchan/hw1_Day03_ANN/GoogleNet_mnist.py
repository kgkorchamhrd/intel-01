...
def Inception(x, filters):
    '''[ref] https://midicvmjw.tistory.com/292'''
...
model = tf.keras.layers.Resizing(224, 224, interpolation="bilinear", crop_to_aspect_ratio=True,
...
model = Inception(model, [128, (128, 356), (24, 64), 64])#c
