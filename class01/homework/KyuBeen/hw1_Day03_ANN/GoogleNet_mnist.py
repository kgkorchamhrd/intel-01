...
def Inception(x, filters):
    ...
    path4 = Conv2D(filters=filters[3],kernel_size=(1,1),strides=1,padding='same',activation='relu')(path3)
...
model = MaxPooling2D(pool_size=(7,7),strides=1,padding='valid')(model)
