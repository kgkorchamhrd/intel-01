...
input_key_en, output_keys_en, compiled_model_en = model_init(model_path_encoder, 'AUTO')
# Decoder initialization
input_key_de, output_keys_de, compiled_model_de = model_init(model_path_decoder, 'AUTO')
